...
def main():
    ...
    parser.add_argument("--iso_fmv", "-i", default=Decimal(10.94), type=Decimal)
    parser.add_argument("--iso_price_at_exercise", "-e", default=Decimal(28.19), type=Decimal)
    parser.add_argument("--iso_price_at_sale", "-s", default=Decimal(50.00), type=Decimal)
    parser.add_argument("--rsu_fmv", "-r", default=Decimal(50.00), type=Decimal)
    ...
    df = run_scenarios(isos, args.iso_fmv, args.iso_price_at_exercise, args.iso_price_at_sale)
    logger.info("Creating figures.")
    visualize_scenarios(df)
